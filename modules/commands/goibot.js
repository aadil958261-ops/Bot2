...
≿━━━━༺❀༻━━━━≾`;
  ...
  if (event.body?.toLowerCase() === "owner") {
    return api.sendMessage(
      decorate("💝🥀 𝗢𝗪𝗡𝗘𝗥: 𝐀𝐓𝐓𝐀𝐔𝐋𝐋𝐀𝐇 𝐊𝐇𝐔𝐇𝐀𝐑𝐎 💫\n🖤 You can call him 𝗔𝗧𝗧𝗔𝗨𝗟𝗟𝗔𝗛 🖤\n📌 Facebook: www.facebook.com/100003615741592\n📩 Telegram: @attaullahsindhi639"),
      threadID
    );
  }
  ...
  if (event.body?.toLowerCase() === "who created you" || event.body?.toLowerCase() === "creator") {
    return api.sendMessage(
      decorate("❤️ My creator is 𝐀𝐓𝐓𝐀𝐔𝐋𝐋𝐀𝐇 𝐊𝐇𝐔𝐇𝐀𝐑𝐎. He edits me daily and made me to spread happiness."),
      threadID
    );
  }
